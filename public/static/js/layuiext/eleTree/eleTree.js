 ...
 * @License：MIT
 * 最近修改时间: 2019/06/05
 * asuma 修改于2019-06-13 获取节点的接口去除被disabled的部分
 */
    ...
    Class.prototype={
        ...
        checkboxEvent: function() {
            ...
            options.elem.on("click",checkOnClickNode,function(e) {
                ...
                if(inp.checked){
                    ...
                    // 点击祖父层选中子孙层
                    if(!options.checkStrictly){
                        // asuma(lishuaiqiu) 修改于2019-06-13
                        childNode.each(function(){
                            if(!$(this).hasClass('eleTree-disabled')){
                                $(this).prop("checked",true).attr("eleTree-status","1");
                            }
                        })
                    }
                }
        ...
        checkboxRender: function() {
            ...
            options.elem.find("input.eleTree-hideen[type=checkbox]").each(function(index,item){
                ...
                //asuma(lishuaiqiu) 修改于2019-06-13
                if(!checkbox.hasClass('eleTree-checkbox-disabled')){
